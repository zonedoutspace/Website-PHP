	...
	<div class="nav navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="container" style="width:80%; padding-top:100px; background-color:white; border-radius:0px;">
 			...
 			<div class="col-md-12">
			      ...
			      <div class="page-header"><h2 style="font-weight:bolder;"><?php echo htmlspecialchars( $results['article']->title )?></h2></div><br>
			      
			      <h4 style="color:#408080; font-weight:bolder;"><?php echo htmlspecialchars($results['article']->date) ?></h4>
			      
			      <div style="width:75%; font-style:italic; font-weight:bolder;"><?php echo htmlspecialchars( $results['article']->summary )?></div><br><br>
			      
			</div>
			
			      <div class="col-md-3">
				      <div class="thumbnail" style="border:0px; border-radius:0px; padding:0px;">
					      <?php if ( $imagePath = $results['article']->getImagePath() ) { ?>
					        <img src="<?php echo $imagePath?>" alt="Article Image" />
					      <?php } ?>
				      </div>
			      </div>
			      
			      <div class="col-md-9" style="background-color:#F4F4F4; border-radius:0px;">
			      	  <h4><?php echo $results['article']->content?></h4><br><br><br>
