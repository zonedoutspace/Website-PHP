...
<body style="background-color:#303030;"> 
	...
	<div class="nav navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="jumbotron" style="border-radius:0px; padding:0px; background-color:white;">
			<div class="page-header"><h2 style="color:black;">ARTICLE ARCHIVE</h2></div>
		</div>
		...
		<?php foreach ( $results['articles'] as $article ) { ?>
		        ...
		        <li>
		          <div class="page-header" id="head" style="width:75%;">
		            <h3><a href=".?action=viewArticle&amp;articleId=<?php echo $article->id?>"><?php echo htmlspecialchars( $article->title )?></a></h3>
		            <h4 style="color:#408080; font-weight:bolder;"><?php echo htmlspecialchars($article->date) ?></h4>
		          </div>
		          ...
		          <div class="col-md-6"><p style="font-family: 'Open Sans', sans-serif; font-weight: 400; line-height:25px;">
		          	<?php echo htmlspecialchars( $article->summary )?></p><br><br><br><br><br>
		          	<h6 style="color:#FF9900;"><i>Published on: <?php echo date('j F Y', $article->publicationDate)?></i></h6>
		          </div>
		...
		<?php } ?>
		      ...
		      <p><?php echo $results['totalRows']?> article<?php echo ( $results['totalRows'] != 1 ) ? 's' : '' ?> 
			  in total.</p>
