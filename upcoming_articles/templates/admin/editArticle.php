...
<?php } ?>
        ...
        <ul>
          ...
          <li>
            ...
            <textarea name="summary" id="summary" placeholder="Brief description of the event" required maxlength="230" style="height: 5em;"><?php echo htmlspecialchars( $results['article']->summary )?></textarea>
          </li>
          ...
          <li>
 		  ...
 		  <li>
 		  	...
 		  	<input type="text" name="date" id="date" placeholder="Scheduled Date" required maxlength="255" value="<?php echo htmlspecialchars( $results['article']->date )?>" />
 		  </li>
