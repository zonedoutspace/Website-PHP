...
<body>
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							<a href="activities.php" class="dropdown-toggle" data-toggle="dropdown">
	...
	<div class="container" style="padding-top:100px;">
		...
		<div class="col-md-8">
			...
			<h2 style="font-family: 'Open Sans', sans-serif; font-weight:400;">Thanks, we have your message and will reply soon.</h2>
				<br><br>
			<center><a href="index.php"><button type="button" class="btn btn-success btn-lg">Home</button></a></center>
		</div>
	...
	<div class="container-fluid" style="padding-top:720px;"></div>
	<!-- Footer ----------------------------------------------------------------------------------------------------------------------------------------------------------->
