<?php
	...
	*/
	class Comments_System {
		 ...
		 */
		function generateComments($pageid = 0, $perpage = 20) {
			...
			$html ="<ul class='media-list' style='background-color:white; padding:10px;'>";
		...
		// This generate tha form, that lets users input Name and their comments.
		function generateForm($location =  '', $type = 0, $comment = false) {
			...
			if( $this->settings['public'] ) {
				...
				$show_name_email = "<div class='col-md-4'><div class='form-group'>
				
				  <label for='comm_name'>Name</label>
				  <input id='comm_name' name='comm_name' type='text' class='form-control' value='$comment->name'>
				...
				<div class='form-group'>
					...
					<input id='comm_email' name='comm_email' type='text' class='form-control' value='$comment->email'>
				...
				<form class='form-horizontal' action='$location#comm_status' method='post'>
					...
					<div class='form-group'>
					  <label class='control-label' for='comm_msg'>Message:</label>
						...
						<textarea class='form-control' rows='6' id='comm_msg' name='comm_msg'>$comment->message</textarea>
					...
					<input type='submit' id='comm_submit' name='comm_submit' class='btn btn-success' value='Submit Post'>
		 ...
		 * @return string           the generated html code
		 */
		function generatePages($pageid, $perpage = 20){
