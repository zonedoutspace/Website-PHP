<!--This template displays the archive of all articles in the CMS. As you can see, it's 
almost identical to homepage.php. It adds an archive CSS class to the unordered list 
so we can style the list items a bit differently to the homepage, and it also adds 
the year to the article publication dates (since the archive might go back a few years). -->
<?php session_start(); ?>
<!DOCTYPE html>
<html lang="en">
...
<!------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------>
	<div class="container" style="padding-top:70px; background-color:white;">
		<div class="col-sm-12">
		<br><br>
	      <h1 style="color:black;">Article Archive</h1>
	     <br><br><br><br>
